...
def save_cached_tensors(unique_id: list[str], tensors_dict: dict[str, torch.Tensor | None]):
    for i, h in enumerate(unique_id):
        cache_path = Path(f"cache/{h}.safetensors")
